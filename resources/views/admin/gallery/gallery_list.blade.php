...
@section('content')
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h4 class="title">Photography List</h4>
                    <br>
                                    ...
                                    @if(!empty($all_galleries))
                                        @foreach($all_galleries as $all_gallery)
                                            <tr>
                                                ...
                                                <td>{!! $all_gallery->category->category_name !!}</td>
                        ...
                        <div class="row" style="padding: 10px">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="gallery_title">
                                    Old Gallery Category
                                </label>
                                <input class="form-control" type="hidden" name="old_category_id" id="old_category_id"  required/>
                                <input class="form-control" readonly type="text" name="old_category_name" id="old_category_name"  required/>
                            </div>
                            <div class="form-group old_cat">
                                <label for="">Select New Category<star>*</star></label>
