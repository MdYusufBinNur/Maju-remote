                        ...
                        <div class="card-content">
                            ...
                            <div class="fresh-datatables">
                                <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    <tbody>
                                    @if(!empty($all_linkers))
                                        @foreach($all_linkers as $all_linker)
                                            <tr>
                                                <td>{!! $all_linker->name !!}</td>
                                                <td>{!! $all_linker->social_link !!}</td>
                                                <td><img src="{!! $all_linker->social_icon !!}" width="32px" height="auto" alt=""> </td>

                                                <td>

                                                    <a href="#" class="btn btn-simple btn-warning btn-icon" data-toggle="modal" onclick="get_linker_data({{$all_linker->id}})" data-target="#BrandModal"><i class="ti-pencil-alt"></i></a>

                                                    <a href="" class="btn btn-simple btn-info btn-icon del_brand"  id="del_brand_item" onclick="deleteSocialLinker({{ $all_linker->id }})"><i class="ti-trash"></i></a>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Social Linker Information</h4>
                </div>
                <form action="{{ url('/update_linker_info') }}" method="post" enctype="multipart/form-data">

                    @csrf()
                    <div class="modal-body">
                        <div class="row" style="padding: 10px">

                            <input type="text" id="linker_id" hidden name="linker_id">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="linker_name" id="linker_name"/>
                            </div>
                            <div class="form-group">
