...
@section('content')
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h4 class="title">Video Service Info List</h4>
                    <br>
                    ...
                    <div class="card">
                                    ...
                                    @if(!empty($all_services))
                                        @foreach($all_services as $all_service)
                                            <tr >
                                                ...
                                                <td class="text-center">{!! $all_service->title !!}</td>

                                                <td class="text-center">{!! substr($all_service->title_description,0,70) !!}</td>
                                                <td class="text-center">
                                                    <img src="{!! $all_service->title_image !!}" width="100px" height="auto" alt=""> </td>
                                                <td class="text-center">
                                                    <a href="#" class="btn btn-simple btn-warning btn-icon" data-toggle="modal" onclick="get_video_service_data({{$all_service->id}})" data-target="#BrandModal"><i class="ti-pencil-alt"></i></a>

                                                    <a href="" class="btn btn-simple btn-info btn-icon del_brand"  id="del_brand_item" onclick="deleteVideoService({{ $all_service->id }})"><i class="ti-trash"></i></a>
                                                </td>
                                            </tr>
                                            @php($i++)
                                        @endforeach
                        ...
                        <div class="card-footer">
                            <button href="" onclick="get_video_service_ordered_data()" type="submit" class="btn btn-sm">Set Priority</button>
                        </div>
                    </div><!--  end card  -->
                </div> <!-- end col-md-12 -->
    ...
    <div class="modal fade" id="BrandModal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form action="{{ url('/update_video_service_info') }}" method="post" enctype="multipart/form-data">

                    @csrf()
                    <div class="modal-body">
                        <div class="row" style="padding: 10px">

                            <input type="text" id="video_service_id" hidden name="service_id">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="title" id="video_title"/>
                            </div>

                            <div class="form-group">
                                <label class="control-label" for="title_description">Service Description<star>*</star></label>
                                <textarea class="form-control" name="title_description" id="video_title_description" type="text" rows="4" ></textarea>
                            </div>
                            <div class="form-group">
