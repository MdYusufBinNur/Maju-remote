    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="card">
                        <form  action="{{ url('/add_new_videography') }}" method="post"  enctype="multipart/form-data" >
                            @csrf()
                            <div class="card-header">
                                <a href="{{ route('videography_list') }}" class="btn btn-outline-dark  pull-right">List</a>

                                <div class="form-group pull-left">
                                    <h5><strong>VIDEOGRAPHY</strong></h5>
                                </div>
